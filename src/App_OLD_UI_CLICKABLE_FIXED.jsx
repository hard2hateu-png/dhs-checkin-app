...
function StaffLogin({ onLogin, onCancel }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100dvh", background: "#0a0a0a", color: "#fff", padding: "24px 20px", justifyContent: "center" }}>
      <div style={{ background: "#111", border: "1px solid #222", borderRadius: 18, padding: 22 }}>
        <div style={{ fontFamily: "'Space Mono', monospace", fontSize: 22, fontWeight: 700, marginBottom: 8 }}>MODO STAFF</div>
        <div style={{ color: "#888", fontSize: 14, marginBottom: 18 }}>Ingresa la contraseña una vez en este dispositivo.</div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            style={{ width: "100%", background: "#00ff88", color: "#000", border: "none", borderRadius: 14, padding: 16, fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: 16, cursor: "pointer" }}
          >
            ENTRAR
          </button>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        <div style={{ background: "#111", border: "1px solid #222", borderRadius: 20, padding: "28px 22px", textAlign: "center" }}>
          ...
          <p style={{ color: "#aaa", fontSize: 15, lineHeight: 1.4, margin: "18px 0 22px" }}>
            {registered ? "Puedes editar tu registro usando este mismo ticket." : "Completa tu registro para este ticket."}
          </p>

          <button
            type="button"
            onClick={onRegister}
            style={{ width: "100%", background: registered ? "#222" : "#00ff88", color: registered ? "#fff" : "#000", border: registered ? "1px solid #333" : "none", borderRadius: 16, padding: 18, fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: 16, cursor: "pointer", marginBottom: 12 }}
          >
          ...
          <a
            href="tel:9726680516"
            style={{ display: "block", width: "100%", background: "#111", color: "#ccc", border: "1px solid #333", borderRadius: 16, padding: 16, boxSizing: "border-box", fontFamily: "'Space Mono', monospace", fontWeight: 700, fontSize: 14, textDecoration: "none" }}
          >
            CONTACTAR A DELINO
          </a>
        </div>
